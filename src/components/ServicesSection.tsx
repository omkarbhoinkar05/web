        ...
        <div className="mt-16 sm:mt-24 p-6 sm:p-8 rounded-3xl bg-zinc-50/80 hover:bg-emerald-50/30 border border-zinc-200/80 shadow-sm transition-colors duration-300">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 items-center text-center">
            ...
            <div className="flex flex-col items-center">
              <div className="w-10 h-10 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center mb-3 text-emerald-600">
              ...
              <span className="text-xs sm:text-sm font-bold text-zinc-800 uppercase tracking-wider mt-1">
                Happy Clients
              </span>
            </div>
